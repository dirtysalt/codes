...
test_cases = [
[Line.new(2.0,3.0).intersect(LineSegment.new(0.0,3.0,3.0,9.0)),LineSegment.new(0.0,3.0,3.0,9.0)],
[Line.new(1.0,0.0).intersect(LineSegment.new(3.0,6.0,9.0,11.0)),NoPoints.new],
[Line.new(5.0,0.0).intersect(LineSegment.new(1.0,5.0,2.0,2.0)),Point.new(1.0,5.0)],
[Line.new(5.0,0.0).intersect(LineSegment.new(-1.0,-1.0,1.0,5.0)),Point.new(1.0,5.0)],
[Line.new(5.0,0.0).intersect(LineSegment.new(-1.0,-1.0,1.0,5.0)),Point.new(1.0,5.0)],
[Line.new(2.0,3.0).intersectLineSegment(LineSegment.new(0.0,3.0,3.0,9.0)),LineSegment.new(0.0,3.0,3.0,9.0)],
[LineSegment.new(0.0,3.0,3.0,9.0).intersect(Line.new(2.0,3.0)),LineSegment.new(0.0,3.0,3.0,9.0)],
[LineSegment.new(0.0,3.0,3.0,9.0).intersectLine(Line.new(2.0,3.0)),LineSegment.new(0.0,3.0,3.0,9.0)],
[LineSegment.new(3.0,6.0,9.0,11.0).intersectLine(Line.new(1.0,0.0)),NoPoints.new],
[LineSegment.new(1.0,5.0,2.0,2.0).intersectLine(Line.new(5.0,0.0)),Point.new(1.0,5.0)],
[LineSegment.new(-1.0,-1.0,1.0,5.0).intersectLine(Line.new(5.0,0.0)),Point.new(1.0,5.0)],
[LineSegment.new(-1.0,-1.0,1.0,5.0).intersectLine(Line.new(5.0,0.0)),Point.new(1.0,5.0)],
[VerticalLine.new(3.0).intersect(LineSegment.new(3.0,0.0,3.0,-2.0)),LineSegment.new(3.0,0.0,3.0,-2.0)],
[VerticalLine.new(2.0).intersect(LineSegment.new(-1.0,-1.0,3.0,3.0)),Point.new(2.0,2.0)],
[VerticalLine.new(3.0).intersect(LineSegment.new(-1.0,-1.0,3.0,3.0)),Point.new(3.0,3.0)],
[VerticalLine.new(-1.0).intersect(LineSegment.new(-1.0,-1.0,3.0,3.0)),Point.new(-1.0,-1.0)],
[VerticalLine.new(-5.0).intersect(LineSegment.new(-1.0,-1.0,3.0,3.0)),NoPoints.new],
[VerticalLine.new(3.0).intersectLineSegment(LineSegment.new(3.0,0.0,3.0,-2.0)),LineSegment.new(3.0,0.0,3.0,-2.0)],
[LineSegment.new(3.0,0.0,3.0,-2.0).intersect(VerticalLine.new(3.0)),LineSegment.new(3.0,0.0,3.0,-2.0)],
[LineSegment.new(3.0,0.0,3.0,-2.0).intersectVerticalLine(VerticalLine.new(3.0)),LineSegment.new(3.0,0.0,3.0,-2.0)],
[LineSegment.new(-1.0,-1.0,3.0,3.0).intersectVerticalLine(VerticalLine.new(2.0)),Point.new(2.0,2.0)],
[LineSegment.new(-1.0,-1.0,3.0,3.0).intersectVerticalLine(VerticalLine.new(3.0)),Point.new(3.0,3.0)],
[LineSegment.new(-1.0,-1.0,3.0,3.0).intersectVerticalLine(VerticalLine.new(-1.0)),Point.new(-1.0,-1.0)],
[LineSegment.new(-1.0,-1.0,3.0,3.0).intersectVerticalLine(VerticalLine.new(-5.0)),NoPoints.new],
[LineSegment.new(5.0,7.0,9.0,9.0).intersect(LineSegment.new(5.0,7.0,6.0,-1.0)),Point.new(5.0,7.0)],
[LineSegment.new(2.0,3.0,8.0,4.0).intersect(LineSegment.new(1.0,1.0,8.0,4.0)),Point.new(8.0,4.0)],
[LineSegment.new(1.0,1.0,4.0,1.0).intersect(LineSegment.new(3.0,0.0,3.0,2.0)),Point.new(3.0,1.0)],
[LineSegment.new(5.0,7.0,9.0,9.0).intersectLineSegment(LineSegment.new(5.0,7.0,6.0,-1.0)),Point.new(5.0,7.0)],
[LineSegment.new(2.0,3.0,8.0,4.0).intersectLineSegment(LineSegment.new(1.0,1.0,8.0,4.0)),Point.new(8.0,4.0)],
[LineSegment.new(1.0,1.0,4.0,1.0).intersectLineSegment(LineSegment.new(3.0,0.0,3.0,2.0)),Point.new(3.0,1.0)],
]
test_cases.each { |input, exp|
  res = input.preprocess_prog.eval_prog([])
  exp = exp.preprocess_prog
  # puts "res = " + res.to_s + ", exp = " + exp.to_s
  if res.to_s != exp.to_s
    puts "[FAILED] input = " + input.to_s + ", res = " + res.to_s + ", exp = " + exp.to_s
  end
}
