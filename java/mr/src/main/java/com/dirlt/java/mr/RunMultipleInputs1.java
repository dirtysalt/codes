...
// single table and multiple file
public class RunMultipleInputs1 {
    public static final String CLASS_NAME = RunMultipleInputs1.class.getSimpleName();
    ...
    public static Job configureJob(Configuration conf, String[] args)
        ...
        job.setJarByClass(RunMultipleInputs1.class);

        // mapper option.
        Scan scan = new Scan();
        scan.setCaching(500);
        TableMapReduceUtil.initTableMapperJob(kInTableName1, scan, TMapper.class, Text.class, Text.class, job);
        MultipleInputs.addInputPath(job, new Path(kInTableName1), TableInputFormat.class, TMapper.class);
