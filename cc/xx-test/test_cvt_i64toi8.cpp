...
void p128_hex_u64(__m128i in) {
    alignas(16) unsigned long long
            v[2]; // uint64_t might give format-string warnings with %llx; it's just long in some ABIs
    _mm_store_si128((__m128i*)v, in);
    printf("v2_u64: %llx %llx\n", v[0], v[1]);
}

void p256_hex_u8(__m256i in) {
    alignas(32) unsigned char
            v[32]; // uint64_t might give format-string warnings with %llx; it's just long in some ABIs
