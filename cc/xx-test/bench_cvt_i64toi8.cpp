...
void Bench() {
    ...
    cout << "native version: N = " << N << ", total = " << ms << ", avg = " << (ms * 1e6) / N / times << "ns(per item)"
         << endl;
    ...
    t.stop();
    ms = t.elapsedMilliseconds();
    cout << "simd avx512 version: N = " << N << ", total = " << ms << ", avg = " << (ms * 1e6) / N / times
         << "ns(per item)" << endl;
#endif
    ...
    t.stop();
    ms = t.elapsedMilliseconds();
    cout << "simd version: N = " << N << ", total = " << ms << ", avg = " << (ms * 1e6) / N / times << "ns(per item)"
         << endl;
    ...
    t.stop();
    ms = t.elapsedMilliseconds();
    cout << "simd2 version: N = " << N << ", total = " << ms << ", avg = " << (ms * 1e6) / N / times << "ns(per item)"
         << endl;
    ...
    t.stop();
    ms = t.elapsedMilliseconds();
    cout << "pack version: N = " << N << ", total = " << ms << ", avg = " << (ms * 1e6) / N / times << "ns(per item)"
         << endl;
}
